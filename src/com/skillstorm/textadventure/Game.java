package com.skillstorm.textadventure;
...
public class Game {
	...
	JLabel tittleNameLabel, hpLabel, hpLabelNumber, weaponLabel, weaponLabelName ;
	...
	public Game() {
		...
		tittleNameLabel = new JLabel("ADVENTURE");
		tittleNameLabel.setForeground(Color.white);
		tittleNameLabel.setFont(titleFont);
		...
		titleNamePanel.add(tittleNameLabel);
	...
	public void createGameScreen() {
		...
		username = JOptionPane.showInputDialog(myWindow, "Enter your username.");
		...
		mainTextArea = new JTextArea("Welcome " + username + "! This game is going to be great.");
	...
	public void attackGuard() {
		...
		mainTextArea.setText("Guard : Hey don't be stupid!\n\nThe guard took his sword out and sliced you. \n(You received 3 damage) ");
		playerHP = playerHP - 3;
		hpLabelNumber.setText("" + playerHP);
		choice1.setText("Go Back");
		choice2.setText("");
	...
	public void north() {
		...
		position = "north";
		mainTextArea.setText("There is a river. \nYou drank the water and rest at the riverside.\n\n(Your HP is recovered by 2)");
		playerHP = playerHP + 2;
		hpLabelNumber.setText("" + playerHP);
	...
	public void west() {
		position = "west";
		mainTextArea.setText("You have encountered a Monster!");
	...
	public void playerAttack() {
		...
		if (weapon.equals("Knife")) {
			playerDamage = new java.util.Random().nextInt(3); //0,1,2
		}
